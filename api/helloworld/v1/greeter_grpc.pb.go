...
func (c *greeterClient) SayHello(ctx context.Context, in *SayHelloReq, opts ...grpc.CallOption) (*SayHelloResp, error) {
...
func (UnimplementedGreeterServer) SayHello(context.Context, *SayHelloReq) (*SayHelloResp, error) {
